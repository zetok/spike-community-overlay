...
SRC_URI="mirror://apache/cassandra/0.7.0/apache-cassandra-0.7.0-beta2-src.tar.gz"
S="${WORKDIR}/apache-cassandra-0.7.0-beta2-src"
...
src_unpack() {
	...
	epatch "${FILESDIR}/01_izaak_names.patch"
	epatch "${FILESDIR}/02_izaak_names.patch"
}
